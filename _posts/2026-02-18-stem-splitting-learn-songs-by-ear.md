...
tags: Tutorial
about_terms: [stem-splitter, vocal-isolation, drum-stem]
mentions_terms: [instrumental, a-cappella, karaoke-track, wav]
---
...
The workflow is pretty simple once you have your stems. Run the song through a stem splitter like [StemSplit.io](https://stemsplit.io), download the individual tracks, and load them into whatever you use to play audio. Most people just use a DAW, but even a basic audio player works.
